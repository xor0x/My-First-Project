		...
		while (current < length) {
			...
			case 'C':
				...
				if (stringAt(in, current, 2, list5)) {
					...
					if (stringAt(in, 0, 4, list10) || stringAt(in, 0, 3, list11) || stringAt(in, current - 2, 6, list12) || stringAt(in, current + 2, 1, list13) || (stringAt(in, current - 1, 1, list14) || (current == 0))
