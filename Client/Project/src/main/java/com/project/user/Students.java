...
public class Students {
	...
	private void initialize() {
		...
		JInternalFrame FirstlFrame = new JInternalFrame(
				greetingService.SelStudentName(1));
...
ActionListener up = new ActionListener() {
		...
		JInternalFrame ThirdlFrame = new JInternalFrame(
				greetingService.SelStudentName(3));
...
ActionListener up2 = new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
                         //   arr3 = new String[5];
		 arr3 = greetingService.getshtml(greetingService.SelStudentName(3))
				.toArray(
						new String[greetingService.getshtml(
		...
		JInternalFrame SecondlFrame = new JInternalFrame(
				greetingService.SelStudentName(2));
...
ActionListener up3 = new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
                     //       arr2 = new String[5];
		 arr2 = greetingService.getshtml(greetingService.SelStudentName(2))
				.toArray(
						new String[greetingService.getshtml(
		...
		JInternalFrame FourlFrame = new JInternalFrame(
				greetingService.SelStudentName(4));
...
ActionListener up4 = new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
                          //  arr4 = new String[5];
		 arr4 = greetingService.getshtml(greetingService.SelStudentName(4))
				.toArray(
						new String[greetingService.getshtml(
		...
		JInternalFrame FivelFrame = new JInternalFrame(
				greetingService.SelStudentName(5));
